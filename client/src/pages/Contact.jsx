    ...
    <div className='bg-primary py-16 pt-28'>
      <form className="flex flex-col items-center text-sm text-slate-800">
        ...
        <p className="max-md:text-sm text-gray-500 pb-10 text-center">
          Or just reach out manually to us at <a href="#" className="text-solid hover:underline">contact@driva.com</a>
        </p>
        ...
        <div className="max-w-96 w-full px-4">
          ...
          <textarea rows="4" className="w-full mt-2 p-2 border border-slate-300 bg-white rounded-lg resize-none outline-none focus:ring-2 focus-within:ring-indigo-400 transition-all" placeholder="Enter your message" required></textarea>
